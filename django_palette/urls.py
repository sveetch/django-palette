...
urlpatterns = [
    ...
    path('source/', ensure_csrf_cookie(SourceFormView.as_view()),
         name='source-post'),
    path('palette/', ensure_csrf_cookie(PaletteFormView.as_view()),
         name='palette-post'),
    path('dump/', ensure_csrf_cookie(DumpFormView.as_view()),
         name='dump-post'),
]
